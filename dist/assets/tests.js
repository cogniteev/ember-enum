...
define('dummy/tests/unit/transforms/enum-test.jscs-test', ['exports'], function (exports) {
  ...
  test('unit/transforms/enum-test.js should pass jscs', function () {
    ok(true, 'unit/transforms/enum-test.js should pass jscs.');
  });
});
define('dummy/tests/unit/transforms/enum-test.jshint', ['exports'], function (exports) {
  'use strict';
