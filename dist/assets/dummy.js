...
define('dummy/ember-enum/tests/modules/ember-enum/enum.jscs-test', ['exports'], function (exports) {
  module('JSCS - modules/ember-enum');
  test('modules/ember-enum/enum.js should pass jscs', function () {
    ok(true, 'modules/ember-enum/enum.js should pass jscs.');
  });
});
define('dummy/ember-enum/tests/modules/ember-enum/enum.jshint', ['exports'], function (exports) {
...
define('dummy/ember-enum/tests/modules/ember-enum/transforms/enum.jscs-test', ['exports'], function (exports) {
  module('JSCS - modules/ember-enum/transforms');
  test('modules/ember-enum/transforms/enum.js should pass jscs', function () {
    ok(true, 'modules/ember-enum/transforms/enum.js should pass jscs.');
  });
});
define('dummy/ember-enum/tests/modules/ember-enum/transforms/enum.jshint', ['exports'], function (exports) {
...
define('dummy/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"dummy","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"ember-enum","version":"0.0.0+98d4753c"},"something":"test","exportApplicationGlobal":true}};
});
...
if (!runningTests) {
  require("dummy/app")["default"].create({"name":"ember-enum","version":"0.0.0+98d4753c"});
}
